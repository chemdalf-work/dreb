...
// ============================================================================
// OAuth API key resolution from ~/.dreb/agent/auth.json
// ============================================================================
...
/** Path to the real dreb agent config directory */
export const DREB_AGENT_DIR = join(homedir(), ".dreb", "agent");

/**
 * Get an AuthStorage instance backed by ~/.dreb/agent/auth.json
