...
`pierre-dreb` is the canonical command. The temporary `pierre-dreb` compatibility command resolves to the same executable, and existing `@dreb/*` packages, `~/.dreb`, project `.dreb`, and `DREB_*` variables remain supported.
